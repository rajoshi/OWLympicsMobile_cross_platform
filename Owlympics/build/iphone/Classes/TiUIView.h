...
/**
 Base class for all Owlympics views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Owlympics view hierarchy (such as wrapped iOS UIViews) was touched.
