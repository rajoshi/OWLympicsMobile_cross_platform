...
@interface OwlympicsObject : KrollCoverageObject {
#else
@interface OwlympicsObject : KrollObject {
#endif
@private
...
extern NSString * Owlympics$ModuleRequireFormat;
