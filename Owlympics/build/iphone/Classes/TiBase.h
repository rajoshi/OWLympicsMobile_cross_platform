...
// in simulator we redefine to format for Owlympics Developer console
...
{\
	NSString * exceptionName = [@"org.owlympics." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.owlympics";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIOwlympicsNativeItemNone = -1, 
	UIOwlympicsNativeItemSpinner = -2,
	UIOwlympicsNativeItemProgressBar = -3,
	
	UIOwlympicsNativeItemSlider = -4,
	UIOwlympicsNativeItemSwitch = -5,
	UIOwlympicsNativeItemMultiButton = -6,
	UIOwlympicsNativeItemSegmented = -7,
	
	UIOwlympicsNativeItemTextView = -8,
	UIOwlympicsNativeItemTextField = -9,
	UIOwlympicsNativeItemSearchBar = -10,
	
	UIOwlympicsNativeItemPicker = -11,
	UIOwlympicsNativeItemDatePicker = -12,
	
	UIOwlympicsNativeItemInfoLight = -13,
	UIOwlympicsNativeItemInfoDark = -14,
	
	UIOwlympicsNativeItemDisclosure = -15,
	
	UIOwlympicsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Owlympics instances of
